...
# Package name
pname = 'algo-trading-python'

# Get the version ... execfile is only on Py2 ... use exec + compile + open
vname = 'version.py'
with open(os.path.join('./', vname)) as f:
    exec(compile(f.read(), vname, 'exec'))

# Generate links
gurl = 'https://github.com/rachit1994/' + pname
...
setuptools.setup(
    ...
    description='Full portfolio management',
    ...
    author_email='rachit.srivastava1994@gmail.com',
